...
import (
	...
	"github.com/cosmos/evm/x/vrf/client/cli"
...
var (
	_ module.AppModule        = AppModule{} //nolint:staticcheck // deprecated but functional; matches upstream modules
...
// AppModuleBasic implements the AppModuleBasic interface for the vrf module.
...
// AppModule implements the AppModule interface for the vrf module.
